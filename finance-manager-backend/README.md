...
Adapter de entrada (HTTP) → Porta de entrada (Input Port) → Caso de uso (implementa a porta de entrada) → Portas de saída (Output Ports) → Adapters de saída (DB, Redis, etc.)


Adapter/input -> Port/input -> UseCase -> Port/output -> Adapter/output